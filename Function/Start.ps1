...
try
{
    ...
    if ($cluster.properties.powerState.code -eq "Stopped")
    {
        $urlStart = "https://management.azure.com/subscriptions/$subscriptionId/resourceGroups/$resourceGroupName/providers/Microsoft.ContainerService/managedClusters/$resourceName/start?api-version=2021-03-01"
